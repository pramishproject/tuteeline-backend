    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('portal_user', 'Portal User'), ('institute_user', 'Institute User'), ('consultancy_user', 'Consultancy User'), ('student_user', 'Student User')], default='student_user', max_length=16)),
